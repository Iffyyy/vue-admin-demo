...
<template>
  <div class="webgl">
    <canvas id="container" width="640" height="380" />
  </div>
</template>
...
const $d3g:any = {}
let renderer: any, stats: any, scene: any, camera: any
...
export default class extends Vue {
  ...
  d3threeD(exports:any) {
    ...
    exports.transformSVGPath = function transformSVGPath(pathStr:any) {
      const path:any = new THREE.ShapePath()
  ...
  addGeoObject(group:any, svgObject:any) {
